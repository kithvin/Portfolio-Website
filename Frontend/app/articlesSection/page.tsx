...
//         <p className="mb-8 w-full max-w-[62ch] text-center text-[13px] leading-6 text-white/70 sm:mb-14 sm:text-sm sm:leading-7 md:max-w-none md:text-base">
...
//             >
//               <div className="grid grid-cols-1 md:grid-cols-[48%_52%] lg:grid-cols-[55%_50%]">
//                 {/* Image Section */}

//                 <div className="relative w-full aspect-[16/9] overflow-hidden rounded-t-[24px] md:h-full md:aspect-auto md:rounded-l-[24px] md:rounded-tr-none">
//                   <motion.div
...
//                   <div className="mb-3 flex flex-wrap items-center gap-3 text-sm text-white/60">
...
//                   <p className="text-justify mt-4 w-full md:max-w-[88%] lg:max-w-[80%] text-sm leading-7 text-white/70 sm:text-base lg:text-lg">
//                     {article.description}
//                   </p>
