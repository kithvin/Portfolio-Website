...
const projects: Project[] = [
  {
    ...
    image: "/Finsage.JPG",
    description:
      "A full featured AI powered wealth management platform that centralizes income, assets, liabilities, and credit card data into a single intelligent dashboard. It delivers real time insights, expense tracking, financial analytics, and AI driven recommendations to help users better understand and manage user finances.",
  ...
  {
    id: 2,
    title: "HireConnect – Technical Hiring Platform (Ongoing)",
    slug: "hireconnect-technical-hiring-platform",
    image: "/HireConnect.png",
    description:
      "A technical hiring and interview practice platform that combines video conferencing, real time chat, and a live coding workspace in one environment. It supports seamless technical interviews, collaborative coding, and real time evaluation for both candidates and recruiters. (Ongoing)",
  ...
  {
    id: 3,
    title: "AlumniHub - Alumni Relationship Platform (Ongoing)",
    slug: "alumnihub-alumni-relationship-platform",
    image: "/Alumni.JPG",
    description:
      "A centralized alumni management system that integrates event management and alumni tracking into a unified platform. It helps institutions manage alumni data, organize events, and maintain better engagement. (Ongoing)",
  ...
  },
  {
    ...
    image: "/Groceezy.png",
    description:
      "A modern grocery shopping platform built with the MERN stack, designed to simplify online grocery purchasing and store management. It features product browsing, cart functionality, order management, and an admin dashboard for inventory and order control.",
  ...
  },
  {
    ...
    description:
      "A feature rich and responsive fashion apparel buying platform built with the MERN stack. It includes product browsing, category filtering, cart functionality, and secure checkout, along with an admin dashboard for managing products and orders.",
  ...
  },
  {
    ...
    image: "/Quickblog.png",
    description:
      "QuickBlog is a smart AI powered blogging platform built with the MERN stack. It enables users to create, edit, and publish blog posts with AI assisted content generation, while providing features like rich text editing, category organization, and a responsive user friendly interface.",
            ...
            >
              ...
              <div className="p-6">
                <Link href={`/projects/${project.slug}`}>
                  <h2 className="text-2xl text-center font-semibold leading-snug text-cyan-300 transition hover:text-cyan-200">
                    {project.title}
                  </h2>
                </Link>
                ...
                <div className="mt-5 justify-center grid grid-cols-2 gap-x-4 gap-y-2 sm:flex sm:flex-wrap">
                  {project.tech.map((t, i) => {
                    const Icon = t.icon;
                    return (
                      <div
                        key={`${project.id}-${t.name}-${i}`}
                        className="flex items-center justify-center gap-1 text-sm text-white/80 sm:justify-center"
                      >
